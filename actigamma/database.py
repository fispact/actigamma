...
class DatabaseJSONFileLoader(object):
    """
        ...
        Following keys are then decay mode type: 'gamma', 'x-ray', ... with spectral data
    """
    __slots__ = [ 'filename' ]
    ...
    def __init__(self, datafile=__RAW_DATABASE_DECAY_2012_FILE__):
        """
            ...
            :param datafile: The filename of the raw JSON file containing the spectral data
        """
...
ABSTRACT_STR_ERROR = "ReadOnlyDatabase should not be instantiated - please extend with your own database."
class ReadOnlyDatabase(object):
    ...
    def __contains__(self, nuclide: str) -> bool:
        """
            ...
            :param nuclide: the radionuclide as a string i.e 'H3' or 'U235m'. No spaces and case sensitive!
    ...
    def raw(self):
        """
            ...
            Allows users to perform own custom queries, but protected to be read only. No setting permitted.
    ...
    def alltypes(self) -> [str]:
        """
            ...
            :returns: a list of strings representing the list of decay types in the database
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
    ...
    def haslines(self, nuclide: str, spectype: str="gamma") -> bool:
        """
            ...
            :param nuclide: the radionuclide as a string i.e 'H3' or 'U235m'. No spaces and case sensitive!
            :param spectype: a string representing the type of decay mode. Gamma is default.
            :returns: boolean based on if spectral data for type exists and has data in database
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
    ...
    def allnuclides(self) -> [str]:
        """
            ...
            :returns: a list of strings representing the list of unique nuclides in the database
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
    ...
    def gettypes(self, nuclide: str) -> [str]:
        """
            ...
            :param nuclide: the radionuclide as a string i.e 'H3' or 'U235m'. No spaces and case sensitive!
            :returns: a list of strings representing the list of unique spcetral types for that nuclide
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
    ...
    def getname(self, zai: int) -> str:
        """
            ...
            :returns: the radionuclide as a string i.e 'H3' or 'U235m'. No spaces and case sensitive!
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
    ...
    def getenergies(self, nuclide: str, spectype: str="gamma"):
        """
            ...
            :param nuclide: the radionuclide as a string i.e 'H3' or 'U235m'. No spaces and case sensitive!
            :param spectype: a string representing the type of decay mode. Gamma is default.
            :returns: a numpy array of energies (eV) for the given nuclide and decay type.
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
    ...
    def getintensities(self, nuclide: str, spectype: str="gamma"):
        """
            Get the corresponding intensity values for each line energy of a given nuclide.
            Default spectral type is "gamma".
            ...
            :param nuclide: the radionuclide as a string i.e 'H3' or 'U235m'. No spaces and case sensitive!
            :param spectype: a string representing the type of decay mode. Gamma is default.
            :returns: a numpy array of normalised intensities for the given nuclide and decay type.
            :raises AbstractClassException: raises an exception if called
        """
        raise AbstractClassException(ABSTRACT_STR_ERROR)
...
class DefaultDatabase(ReadOnlyDatabase):
    """
        ...
        This assumes the datasource is a JSON file loader, conforming to the correct schema
    ...
    def gettypes(self, nuclide: str) -> [str]:
        ...
        """
        return [k for k, _ in self.raw[nuclide].items() if k not in self.IGNORE_KEYS ]
    ...
    def getintensities(self, nuclide: str, spectype: str="gamma"):
        ...
        """
        if self.haslines(nuclide, spectype=spectype):
            return [ intensity*self.raw[nuclide][spectype]['lines']['norms'][i] 
                    for i,intensity in enumerate(self.raw[nuclide][spectype]['lines']['intensities'])]
        return []


# some aliases for decay data
def Decay2012Database():
    return DefaultDatabase(datasource=DatabaseJSONFileLoader(datafile=__RAW_DATABASE_DECAY_2012_FILE__))